const conversationTree = {
  ...
  FloorNode: {
    message: "Which floor do you need? Please select a floor by entering the corresponding number:",
    options: [
      { text: "Ground floor", identifier: "00", next: "FinalNode" },
      { text: "First floor", identifier: "01", next: "FinalNode" },
      { text: "Second floor", identifier: "02", next: "FinalNode" },
      { text: "Third floor", identifier: "03", next: "FinalNode" },
      { text: "Fourth floor", identifier: "04", next: "FinalNode" },
      { text: "Library", identifier: "90", next: "FinalNode" },
      { text: "Computer Lab", identifier: "91", next: "FinalNode" },
      { text: "Overhead Tank", identifier: "96", next: "FinalNode" },
      { text: "SS Tank", identifier: "97", next: "FinalNode" },
      { text: "Sump", identifier: "98", next: "FinalNode" },
      { text: "Parking", identifier: "99", next: "FinalNode" },
    // ... other floor options ...
    ],
  },
